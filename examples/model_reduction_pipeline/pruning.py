...
class ModelPruning:
    ...
    def apply_pruning(self, train_images):
        ...
        pruning_params = {
            "pruning_schedule": tfmot.sparsity.keras.PolynomialDecay(
                ...
                final_sparsity=0.75,  # End with 75% sparsity
                begin_step=0,
                end_step=end_step,
            )
        }
    ...
    def strip_pruned_model(self):
        ...
        try:
            ...
            # Recompile the stripped model with the same configuration
    ...
    def evaluate_pruned_model(self, test_images, test_labels):
        ...
        # Strip the model before final evaluation
        ...
        # Calculate compression ratio using stripped model
        self._calculate_compression_ratio()

        # Save metrics after getting both accuracies
        if (
