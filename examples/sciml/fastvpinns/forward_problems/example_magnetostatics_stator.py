...
This file is part of Zenvin Engines Platform.

NOTICE: All information contained herein is, and remains the property of 
Zenteiq Aitech Innovations Private Limited and its suppliers, if any. The 
intellectual and technical concepts contained herein are proprietary to 
Zenteiq Aitech Innovations Private Limited and may be covered by patents, 
...
Zenteiq Aitech Innovations Private Limited
Email: license@zenteiq.com
Website: https://zenteiq.ai
"""

"""
Example script for solving a 2D Poisson equation for electrostatics
using FastvPINNs.
...
from scirex.core.sciml.fastvpinns.model.model_magnetostatic_bvp import (
    DenseModel,
    MagnetisationModel,
)
from scirex.core.sciml.fastvpinns.physics.magnetostatics import pde_loss_magnetostatics

i_mesh_type = "quadrilateral"  # "quadrilateral"
i_mesh_generation_method = "external"  # "internal" or "external"
i_mesh_file_name = "tests/support_files/stator.mesh"  # should be a .mesh file
...
i_output_path = "output/magnetostatics_stator_normalizedeqn_2"  # Output path
