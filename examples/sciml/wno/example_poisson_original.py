...
sub = 3
h = int(((129 - 1)/sub) + 1) # total grid size divided by the subsampling rate
...
"""
torch.save(model, 'model/WNO_allencahn')
scipy.io.savemat('results/wno_results_allencahn.mat', mdict={'x_test':x_test.cpu().numpy(),
