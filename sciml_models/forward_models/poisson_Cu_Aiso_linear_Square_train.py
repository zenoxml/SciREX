...
i_output_path = "output/poisson_Cu_Aiso_Linear_Square_train"  # Output path
...
def rhs(x, y):
    ...
    return 12 * x - 20 * y + (x - 2 * y) * (25 * np.sin(5 * y) + 4) + 10 * np.cos(5 * y)
...
weights_file_path = output_folder / "model_poisson_cu_aiso_linear_square_weights.h5"
