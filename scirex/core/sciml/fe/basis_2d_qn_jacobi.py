...
"""
    ...
    This module implements a specialized basis function class for 2D QN finite elements using Jacobi polynomials. 
    ...
    Classes:
        Basis2DQNJacobi: Main class implementing 2D basis functions using Jacobi polynomials
    ...
    Key Features:
        - Implementation of 2D QN element basis functions using Jacobi polynomials
